...
public:
    ...
    void RenderMT(const Scene &scene, const Camera &camera, Image &image) const;
...
private:
    ...
    void RenderRows(const Scene &scene, const Camera &camera, Image &image, int start_row, int end_row) const;
};
